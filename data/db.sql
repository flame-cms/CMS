...
--
-- Počítač: wm20.wedos.net:3306
-- Vygenerováno: Čtv 15. lis 2012, 17:31
-- Verze MySQL: 5.5.23
-- Verze PHP: 5.4.6
...
--
-- Databáze: `d16533_jscms`
--

-- --------------------------------------------------------

--
-- Struktura tabulky `flame_category`
--

CREATE TABLE IF NOT EXISTS `flame_category` (
...
--
-- Vypisuji data pro tabulku `flame_category`
--
...
--
-- Struktura tabulky `flame_comment`
--

CREATE TABLE IF NOT EXISTS `flame_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Struktura tabulky `flame_link`
--

CREATE TABLE IF NOT EXISTS `flame_link` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_link`
--
...
--
-- Struktura tabulky `flame_menu`
--

CREATE TABLE IF NOT EXISTS `flame_menu` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_menu`
--
...
--
-- Struktura tabulky `flame_newsreel`
--

CREATE TABLE IF NOT EXISTS `flame_newsreel` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_newsreel`
--
...
--
-- Struktura tabulky `flame_option`
--

CREATE TABLE IF NOT EXISTS `flame_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_option`
--
...
--
-- Struktura tabulky `flame_page`
--

CREATE TABLE IF NOT EXISTS `flame_page` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_page`
--
...
--
-- Struktura tabulky `flame_post`
--

CREATE TABLE IF NOT EXISTS `flame_post` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` int(11) DEFAULT NULL,
...
--
-- Vypisuji data pro tabulku `flame_post`
--
...
--
-- Struktura tabulky `flame_post_tag`
--

CREATE TABLE IF NOT EXISTS `flame_post_tag` (
...
--
-- Vypisuji data pro tabulku `flame_post_tag`
--
...
--
-- Struktura tabulky `flame_tag`
--

CREATE TABLE IF NOT EXISTS `flame_tag` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `slug` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`),
...
--
-- Vypisuji data pro tabulku `flame_tag`
--
...
--
-- Struktura tabulky `flame_user`
--

CREATE TABLE IF NOT EXISTS `flame_user` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Vypisuji data pro tabulku `flame_user`
--
...
--
-- Struktura tabulky `flame_user_info`
--

CREATE TABLE IF NOT EXISTS `flame_user_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Omezení pro tabulku `flame_category`
--
ALTER TABLE `flame_category`
  ADD CONSTRAINT `FK_E011A29E727ACA70` FOREIGN KEY (`parent_id`) REFERENCES `flame_category` (`id`) ON DELETE SET NULL;

--
-- Omezení pro tabulku `flame_comment`
--
ALTER TABLE `flame_comment`
  ADD CONSTRAINT `FK_AA930C234B89032C` FOREIGN KEY (`post_id`) REFERENCES `flame_post` (`id`) ON DELETE CASCADE;

--
-- Omezení pro tabulku `flame_page`
--
ALTER TABLE `flame_page`
  ADD CONSTRAINT `FK_A4304C3EA76ED395` FOREIGN KEY (`user_id`) REFERENCES `flame_user` (`id`);

--
-- Omezení pro tabulku `flame_post`
--
ALTER TABLE `flame_post`
  ADD CONSTRAINT `FK_EAB0969312469DE2` FOREIGN KEY (`category_id`) REFERENCES `flame_category` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `FK_EAB09693A76ED395` FOREIGN KEY (`user_id`) REFERENCES `flame_user` (`id`);

--
-- Omezení pro tabulku `flame_post_tag`
--
ALTER TABLE `flame_post_tag`
  ADD CONSTRAINT `FK_BC9381AF4B89032C` FOREIGN KEY (`post_id`) REFERENCES `flame_post` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_BC9381AFBAD26311` FOREIGN KEY (`tag_id`) REFERENCES `flame_tag` (`id`) ON DELETE CASCADE;

--
-- Omezení pro tabulku `flame_user`
--
ALTER TABLE `flame_user`
  ADD CONSTRAINT `FK_3DA92C575D8BC1F8` FOREIGN KEY (`info_id`) REFERENCES `flame_user_info` (`id`) ON DELETE CASCADE;
